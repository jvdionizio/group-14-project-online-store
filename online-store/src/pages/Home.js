    ...
    return (
      <>
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <button type="submit" onClick={handleClick} data-testid="query-button">
            Atualizar
          </button>
        </form>

        <Categories categorySelect={categorySelect} searchCategory={searchCategory} />
        {loading ? (
          <p>Carregando...</p>
        ) : (
          <Products {...this.props} productsInfos={productsInfos} addProduct={addProduct} />
        )}
      </>
    );
  }
